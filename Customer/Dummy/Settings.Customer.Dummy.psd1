...
@{
    ...
    TemplateName = 'KPN Dossier Dummy.dotx'
    ...
    MailTemplates = @{
        '1. Introductory Mail (Dummy)' = @{
            Subject = 'Dummy: Introductie Intake APPNAME - (REFERENCENUMBER)'
            Body    = 'Hallo NAAM,
...
NAAM'
        ...
        '2. Request Source files (Dummy)' = @{
            Subject = 'Dummy: Intake APPNAME - (REFERENCENUMBER)'
            Body    = 'Hallo NAAM,
...
NAAM'
        ...
        '3. Request Intake Approval (Dummy)' = @{
            Subject = 'Dummy: Goedkeuring Intakedocument APPNAME - (REFERENCENUMBER)'
            Body    = 'Hallo NAAM,
...
NAAM'
        ...
        '4. Intake Reminder (Dummy)' = @{
            Subject = 'Dummy: Reminder Goedkeuring Intakedocument APPNAME - (REFERENCENUMBER)'
            Body    = 'Hallo NAAM,
