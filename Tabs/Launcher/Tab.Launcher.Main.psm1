...
function Import-TabLauncher {
    ...
    try {
        ...
        # Import the Features
        [System.Windows.Forms.GroupBox]$SystemFolderGroupBox = New-GroupBox -InputObject $InputObject -ParentTabPage $ParentTabPage -Title 'System Folders' -NumberOfRows 3
    }
    catch {
